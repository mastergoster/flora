...
use Tests\Core\Controller\Database\DatabaseMysqlControllerTestInterface;

class DatabaseMysqlControllerTest extends TestCase
{
    private $pdo;
    ...
    {
        $bdd = new DatabaseMysqlControllerTestInterface($this->fileName);
